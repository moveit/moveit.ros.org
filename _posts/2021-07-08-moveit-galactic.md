...
The release is currently only available as source install as we are still working on some issues with the build farm. For getting started, check out the [install instructions](/install-moveit2/source/) and the [tutorials](https://moveit.picknik.ai/).

### What's next...
You can always find out more about what features and fixes are in the next version of MoveIt on the [MoveIt Roadmap](/documentation/contributing/roadmap/) along with long term goals and sprint plans.
