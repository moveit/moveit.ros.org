...
Moveit offers different [default capabilities](https://github.com/ros-planning/moveit/tree/kinetic-devel/moveit_ros/move_group/src/default_capabilities). Plugins can be configured through ROS yaml parameters and the ROS plugin library. Usually the launch files generated by the Moveit Setup Assistant are already configured.
