...
- [UNISA Automatic Control Group](https://github.com/unisa-acg/moveit_dp_redundancy_resolution) in *Globally Optimal Redundancy Resolution with Dynamic Programming for Robot Planning: A ROS Implementation* published on [MDPI Robotics](https://www.mdpi.com/2218-6581/10/1/42). Optimal kineto-dynamic trajectory planning for kinematically redundant robots, based on dynamic programming. Demos on a 4R planar robot and Franka Emika's Panda robot are provided. Extended MoveIt planning capabilities by computing optimal joint-space trajectories for redundant robots along pre-scribed workspace paths, considering actuation limits.
